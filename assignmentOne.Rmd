...
Mean number of total steps per day is `r text1`.  

The median total number of steps per day is `r text2`.
...
The interval starting at `r text3` has the highest average steps at `r text4`.
...
Imputed Mean Total Number of Steps Per is `r text5`.  
  
Imputed Median Total Number of Steps per Day is `r text6`.  
